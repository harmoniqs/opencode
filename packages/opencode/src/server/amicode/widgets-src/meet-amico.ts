...
export default {
  mount: function (el, amico) {
    ...
    el.innerHTML =
      ...
      // mark sits in the SAME neutral tile as the About-You avatar (consistency, Kate)
      '<div style="width:44px;height:44px;flex-shrink:0;border-radius:12px;background:var(--amc-layer2);display:flex;align-items:center;justify-content:center">' +
      FACE +
      '</div>' +
