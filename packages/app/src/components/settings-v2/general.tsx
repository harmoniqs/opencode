  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        {/* the fork's showSessionProgressBar row was dropped in the upstream
            merge — its only consumer (the timeline progress bar) lived in the
            old message-timeline, which upstream replaced. */}
