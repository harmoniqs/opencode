...
Upstream: anomalyco/opencode `dev` @ `4d68d30b48a99379b2baaf597dbad576707ea36d` (`4d68d30b4`, version `1.18.18`)
Base: harmoniqs/opencode `local/amicode` @ d444bc333
Branch: `notturno/merge-upstream-2026-08-17`
...
## Next steps
1. `git fetch upstream && git checkout notturno/merge-upstream-2026-08-17 && git merge upstream/dev`
